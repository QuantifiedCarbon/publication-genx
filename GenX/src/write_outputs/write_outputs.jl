...
function write_outputs(EP::Model, path::AbstractString, setup::Dict, inputs::Dict)
	...
	elapsed_time_net_rev_new = @elapsed write_net_revenue_new(path, inputs, setup, EP, dfCap, dfESRRev, dfResRevenue, dfChargingcost, dfPower, dfEnergyRevenue, dfSubRevenue, dfRegSubRevenue)
	println("Time elapsed for writing net revenue new is")
	println(elapsed_time_net_rev_new)
	elapsed_time_net_rev_existing = @elapsed write_net_revenue_existing(path, inputs, setup, EP, dfCap, dfESRRev, dfResRevenue, dfChargingcost, dfPower, dfEnergyRevenue, dfSubRevenue, dfRegSubRevenue)
	println("Time elapsed for writing net revenue existing is")
	println(elapsed_time_net_rev_existing)
	#end
	## Print confirmation
