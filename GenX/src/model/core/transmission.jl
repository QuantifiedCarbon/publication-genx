...
function transmission!(EP::Model, inputs::Dict, setup::Dict)
	...
	Transmission_variability = setup["Transmission_variability"]
	...
	if Transmission_variability == 1
		println("\tUsing Transmission_variability constraints")
		@constraints(EP, begin
			cMaxFlow_out[l=1:L, t=1:T], vFLOW[l,t] <= eAvail_Trans_Cap[l]*inputs["pTransVar_Max"][2*l-1, t]
			cMaxFlow_in[l=1:L, t=1:T], vFLOW[l,t] >= -eAvail_Trans_Cap[l]*inputs["pTransVar_Max"][2*l, t]
		end)
	else
		@constraints(EP, begin
